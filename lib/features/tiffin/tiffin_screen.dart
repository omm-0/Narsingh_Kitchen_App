    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<ProductModel>>(
        ...
        builder: (context, snapshot) {
          ...
          final today = visible.isNotEmpty ? visible.first : null;

          return StreamBuilder<List<SubscriptionModel>>(
            stream: SubscriptionService.instance.getPlans(),
            builder: (context, plansSnapshot) {
              final plans = plansSnapshot.data ?? const <SubscriptionModel>[];
              return Stack(
                            ...
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                ...
                                colors: [
                                  ...
                                  AppColors.lightOrangeBg.withValues(
                                    alpha: 0.95,
                                  ),
                                ],
                              ),
                      ...
                      SliverPadding(
                        ...
                        sliver: SliverToBoxAdapter(
                          child: Column(
                            ...
                            children: [
                              if (snapshot.hasError || plansSnapshot.hasError)
                                Padding(
                                  padding: const EdgeInsets.only(bottom: 14),
                                  child: Text(
                                    'Live tiffin data is unavailable. Showing starter meal plans.',
                                    style: GoogleFonts.poppins(
                                      fontSize: 12,
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                const SizedBox(height: 10),
                                                Text(
                                                  '₹${today.price.toStringAsFixed(0)}/meal',
                                                  style: GoogleFonts.poppins(
                                                    fontWeight: FontWeight.w700,
                                                    fontSize: 16,
                                                    color:
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(height: 8),
                                      Text(
                                        'Buy today\'s meal once and it will be added to cart for checkout like any normal order.',
                                        style: GoogleFonts.poppins(
                                          fontSize: 13,
                                          color: AppColors.textSecondary,
                                          height: 1.45,
